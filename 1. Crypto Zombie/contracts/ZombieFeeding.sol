...
인터페이스 함수를 상속 받아서 override 할 때 0.8 버전 이후부터는 다중 상속을 받는 경우가 아닌 이상 더이상 override 키워드를 사용하지 않아도 된다.
...
contract ZombieFeeding is ZombieFactory {
    ...
    */
    ...
    function feeAndMuliply(uint _zombieId, uint _targetDna, string memory _species) internal onlyOwnerOf(_zombieId) {
